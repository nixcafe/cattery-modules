		...
		script: [{
			...
			textContent: {
				...
				"@graph": [{
                    ...
                    const docsBoost = isDocsPath ? 1.5 : 1;
                    return priority * depthBoost * docsBoost;
                }`,combineWith:`AND`,fuzzy:.2,prefix:!0,boost:{title:4,subtitle:3,text:2,category:1,titles:1}},sidebar:[{text:`Introduction`,link:`/`},{text:`Guide`,collapsed:!1,items:[{text:`Quick Start`,link:`/quick-start`},{text:`Rooms`,link:`/rooms`},{text:`Modules`,link:`/modules`},{text:`Secrets & agenix`,link:`/secrets`}]},{text:`Development`,collapsed:!1,items:[{text:`Contributing`,link:`/contributing`}]}],socials:[{icon:`github`,link:`https://github.com/nixcafe`}],srcDir:`src`,title:`cattery`,titleTemplate:`%s – cattery`,trailingSlashRedirect:!0};export{e as t};